...
export class categoriasFactor1628818642883 implements MigrationInterface {
    name = 'categoriasFactor1628818642883'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "categorias" ("_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "categoria" character varying NOT NULL, "descrição" character varying NOT NULL, "eventos" character varying NOT NULL, CONSTRAINT "PK_88d50790c2aca1fa6256efb3099" PRIMARY KEY ("_id"))`);
    }
